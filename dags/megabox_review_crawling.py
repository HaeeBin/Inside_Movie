                ...
                try:
                    ...
                    for review in review_items:
                        try:
                            ...
                            context = review.find_element(By.CLASS_NAME, 'story-txt').text.strip() if review.find_element(By.CLASS_NAME, 'story-txt') else None
                            rating = review.find_element(By.CSS_SELECTOR, 'div.story-point > span').text.strip() if review.find_element(By.CSS_SELECTOR, 'div.story-point > span') else None
                            review_date_defore = review.find_element(By.CSS_SELECTOR, 'div.story-date > div > span').text.strip() if review.find_element(By.CSS_SELECTOR, 'div.story-date > div > span') else None
                            em_tags = review.find_element(By.CLASS_NAME, 'story-recommend').find_elements(By.TAG_NAME, 'em') if review.find_element(By.CLASS_NAME, 'story-recommend').find_elements(By.TAG_NAME, 'em') else None
