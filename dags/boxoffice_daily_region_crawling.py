...
def load_region_codes_from_gcs(**kwargs):
    ...
    kwargs["ti"].xcom_push(key="load_region_codes_from_gcs", value=df.to_dict("records"))
...
def request_region_api(**kwargs):
    ...
    region_codes = kwargs["ti"].xcom_pull(task_ids="load_region_codes_from_gcs", key="load_region_codes_from_gcs")
...
def parse_daily_region_boxoffice_data(**kwargs):
    ...
    '''     
    all_data = kwargs["ti"].xcom_pull(task_ids='request_region_api', key='daily_region_box_office_data')
    ...
    if all_df:
        ...
        kwargs["ti"].xcom_push(key="parse_region_boxoffice_data", value=result.to_json())
...
def upload_to_gcs(**kwargs):
    ...
    data = kwargs["ti"].xcom_pull(task_ids='parse_daily_region_boxoffice_data', key='parse_region_boxoffice_data')
...
with DAG(
    ...
    load_region_codes_from_gcs >> request_region_api >> parse_daily_region_boxoffice_data >> upload_to_gcs